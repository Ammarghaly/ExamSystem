...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen flex-col lg:flex-row bg-[#fcf8ff] dark:bg-[#101214] font-sans">
       ...
       <div className="absolute inset-0 z-0 bg-gradient-to-br from-[#818cf8] to-[#4f46e5] opacity-90"></div>
        ...
        <div className="relative z-10 w-full mx-auto flex flex-col justify-center py-2">
          ...
          <p className="text-lg xl:text-xl font-medium text-[#dad7ff]/90 mb-8 lg:mb-12 leading-relaxed">
            Continue your journey of academic excellence with AI-driven mentorship and smart assessments.
          </p>
      ...
      {/* Right Side */}
      <section className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 md:p-12 overflow-y-auto bg-[#fcf8ff] dark:bg-[#101214]">
        <div className="w-full max-w-[440px] my-auto">
          ...
          <div className="bg-white dark:bg-[#1f2226] rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-[#e4e1ee] dark:border-white/5 p-6 sm:p-8 transition-all duration-300">
            <LoginForm />
          </div>
        </div>
      </section>
